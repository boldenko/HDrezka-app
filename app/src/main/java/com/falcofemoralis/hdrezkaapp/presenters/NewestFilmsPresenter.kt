...
class NewestFilmsPresenter(private val newestFilmsView: NewestFilmsView, private val filmsListView: FilmsListView) : Filters.IFilter, FilmsListPresenter.IFilmsList {
    ...
    override fun applyFilters() {
        val sortItem = filters.appliedFilters[Filters.AppliedFilter.SORT]?.get(0)
        if (sortItem != null) {
